...
export function getRandomInt(min:number, max:number) : number{
  ...
  class dataPoint {
    ...
    kitchen_countertops_1860[3] = new dataPoint( new UIImage(designStudioCanvas, new Texture('imagesUI/DesignStudio_Interface/Kitchen_Countertops/kitchen_countertops_expo_gray_ceontino.png')), new GLTFShape('models/KB_Homes/1860/custom/kitchen_countertops/Countertops_QuartzCalacattaUltra.glb'))
