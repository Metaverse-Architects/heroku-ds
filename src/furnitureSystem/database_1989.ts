...
export function getRandomInt(min:number, max:number) : number{
  ...
  class dataPoint {
    ...
    bathroom_backsplash_1989[2] = new dataPoint( new UIImage(designStudioCanvas, new Texture('imagesUI/DesignStudio_Interface/Bathroom_backsplash/bathroom_backsplash_sculpture.png')), new GLTFShape('imagesUI/DesignStudio_Interface/Bathroom_backsplash/bathroom_backsplash_sculpture.glb'))
    bathroom_backsplash_1989[3] = new dataPoint( new UIImage(designStudioCanvas, new Texture('imagesUI/DesignStudio_Interface/Bathroom_backsplash/bathroom_backsplash_sweden.png')), new GLTFShape('models/KB_Homes/1989/custom/bathroom_backsplash/BP_BackplashSwedenVadretPolished.glb'))
