...
/** @public */
export declare type RouterOptions = Partial<{
...
/** @public */
export declare type AllowedMethodOptions = Partial<{
    throw: boolean;
    notImplemented: NewableFunction;
    methodNotAllowed: NewableFunction;
}>;
/** @public */
export declare type RoutedContext<Context, Path extends string> = IHttpServerComponent.PathAwareContext<Context, Path> & {
    captures: string[];
    matched?: Layer<Context, Path>[];
    routerPath?: string;
};
/** @public */
export declare type RoutePathSignature<Context extends {}> = <T extends string>(path: T, ...middlewares: Array<IHttpServerComponent.IRequestHandler<RoutedContext<Context, T>>>) => Router<Context>;
/**
 * Create a new router.
 *
 * @example
