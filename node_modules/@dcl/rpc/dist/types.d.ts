 ...
 * @public
 */
export declare type Transport = Pick<Emitter<TransportEvents>, "on" | "emit"> & {
 ...
 * @public
 */
export declare type CallableProcedureServer<Context> = (payload: Uint8Array | AsyncIterable<Uint8Array>, context: Context) => AsyncProcedureResultServer;
/**
 * @public
 */
export declare type CallableProcedureClient = (payload: Uint8Array | AsyncIterable<Uint8Array>) => AsyncProcedureResultClient;
/**
 * @public
 */
export declare type ServerModuleProcedure<Context> = {
 ...
 * @public
 */
export declare type ServerModuleDeclaration<Context> = {
    procedures: ServerModuleProcedure<Context>[];
};
/**
 * @public
 */
export declare type ServerModuleDefinition<Context> = Record<string, CallableProcedureServer<Context>>;
/**
 * @public
 */
 ...
 * @public
 */
export declare type RpcClientPort = Pick<Emitter<RpcPortEvents>, "on" | "all"> & {
 ...
 * @public
 */
export declare type ModuleGeneratorFunction<Context> = (port: RpcServerPort<Context>, context: Context) => Promise<ServerModuleDefinition<Context>>;
/**
 * @public
 */
export declare type RpcServerPort<Context> = Pick<Emitter<RpcPortEvents>, "on" | "emit"> & {
    readonly portId: number;
    readonly portName: string;
    /**
 ...
 * @public
 */
export declare type RpcServer<Context = {}> = Pick<Emitter<RpcServerEvents>, "on" | "emit"> & {
 ...
 * @public
 */
export declare type RpcServerHandler<Context> = (serverPort: RpcServerPort<Context>, transport: Transport, context: Context) => Promise<void>;
