...
export declare type ClientMethod<Definition extends MethodDefinition<any, any, any, any>, CallOptionsExt = {}> = Definition["requestStream"] extends false ? Definition["responseStream"] extends false ? UnaryClientMethod<MethodRequest<Definition>, MethodResponse<Definition>, CallOptionsExt> : Definition["responseStream"] extends true ? ServerStreamingMethod<MethodRequest<Definition>, MethodResponse<Definition>, CallOptionsExt> : never : Definition["requestStream"] extends true ? Definition["responseStream"] extends false ? ClientStreamingMethod<MethodRequest<Definition>, MethodResponse<Definition>, CallOptionsExt> : Definition["responseStream"] extends true ? BidirectionalStreamingMethod<MethodRequest<Definition>, MethodResponse<Definition>, CallOptionsExt> : never : never;
...
export declare type ServerStreamingMethod<Request, Response, CallOptionsExt = {}> = (request: Request, options?: CallOptions & CallOptionsExt) => AsyncGenerator<Response>;
export declare type ClientStreamingMethod<Request, Response, CallOptionsExt = {}> = (request: AsyncIterable<Request>, options?: CallOptions & CallOptionsExt) => Promise<Response>;
export declare type BidirectionalStreamingMethod<Request, Response, CallOptionsExt = {}> = (request: AsyncIterable<Request>, options?: CallOptions & CallOptionsExt) => AsyncGenerator<Response>;
