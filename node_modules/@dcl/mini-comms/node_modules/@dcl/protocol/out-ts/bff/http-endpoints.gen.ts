...
export interface AboutResponse_BaseService {
  healthy: boolean;
...
function createBaseAboutResponse_BaseService(): AboutResponse_BaseService {
  return { healthy: false, version: undefined, commitHash: undefined, publicUrl: undefined };
}

export const AboutResponse_BaseService = {
  encode(message: AboutResponse_BaseService, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.healthy === true) {
      writer.uint32(8).bool(message.healthy);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AboutResponse_BaseService {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAboutResponse_BaseService();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): AboutResponse_BaseService {
    return {
      healthy: isSet(object.healthy) ? Boolean(object.healthy) : false,
  ...
  toJSON(message: AboutResponse_BaseService): unknown {
    const obj: any = {};
    message.healthy !== undefined && (obj.healthy = message.healthy);
  ...
  fromPartial<I extends Exact<DeepPartial<AboutResponse_BaseService>, I>>(object: I): AboutResponse_BaseService {
    const message = createBaseAboutResponse_BaseService();
    message.healthy = object.healthy ?? false;
...
export const AboutResponse_AboutConfiguration = {
  ...
  fromJSON(object: any): AboutResponse_AboutConfiguration {
    return { realmName: isSet(object.realmName) ? String(object.realmName) : undefined };
  },
