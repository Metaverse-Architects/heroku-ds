...
export interface Heartbeat {
  ...
  currentAdapter?: string | undefined;
}
...
function createBaseHeartbeat(): Heartbeat {
  return { position: undefined, desiredRoom: undefined, currentAdapter: undefined };
}
...
export const Heartbeat = {
  encode(message: Heartbeat, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.currentAdapter !== undefined) {
      writer.uint32(26).string(message.currentAdapter);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.currentAdapter = reader.string();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Heartbeat {
    return {
      ...
      currentAdapter: isSet(object.currentAdapter) ? String(object.currentAdapter) : undefined,
    };
  },
  ...
  toJSON(message: Heartbeat): unknown {
    ...
    message.currentAdapter !== undefined && (obj.currentAdapter = message.currentAdapter);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Heartbeat>, I>>(object: I): Heartbeat {
    ...
    message.currentAdapter = object.currentAdapter ?? undefined;
    return message;
  },
};
