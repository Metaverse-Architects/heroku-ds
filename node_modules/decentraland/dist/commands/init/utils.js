    ...
    const projectTypeList = [
        {
            ...
            choices: [
                ...
                {
                    name: 'Smart Item',
                    value: schemas_1.sdk.ProjectType.SMART_ITEM
                },
                {
...
function getRepositoryUrl(choice) {
    ...
    if (choice.value === schemas_1.sdk.ProjectType.SMART_ITEM) {
        return repositories_1.default.smartItem;
    }
    if (choice.value === schemas_1.sdk.ProjectType.PORTABLE_EXPERIENCE) {
        return repositories_1.default.portableExperience;
    }
